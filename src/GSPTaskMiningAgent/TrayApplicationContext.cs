...
internal sealed class TrayApplicationContext : ApplicationContext
{
    ...
    {
        paths.EnsureAll();
        _notifyIcon = new NotifyIcon { Icon = SystemIcons.Application, Text = "GSP Task Mining: работает", Visible = true, ContextMenuStrip = BuildMenu(paths) };
    ...
    protected override void Dispose(bool disposing){if(disposing){_cts.Cancel();_notifyIcon.Text="GSP Task Mining: остановка";_notifyIcon.Visible=false;_notifyIcon.Dispose();_cts.Dispose();}base.Dispose(disposing);} 
}
